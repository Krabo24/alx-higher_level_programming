...
class TestRectangle_width(unittest.TestCase):
    ...
    def test_None_width(self):
        with self.assertRaisesRegex(TypeError, "width must be integer"):
            Rectangle(None, 2)
    ...
    def test_float_width(self):
        with self.assertRaisesRegex(TypeError, "width must be a integer"):
            Rectangle(5.5, 1)
...
class TestRectangle_height(unittest.TestCase):
    ...
    def test_float_height(self):
        with self.assertRaisesRegex(TypeError, "height must be integer"):
            Rectangle(1, 5.5)

    def test_complex_height(self):
        with self.assertRaisesRegex(TypeError, "height must be a integer"):
...
class TestRectangle_x(unittest.TestCase):
    ...
    def test_memoryview_x(self):
        with self.assertRaisesRegex(TypeError, "x must be a integer"):
...
class TestRectangle_y(unittest.TestCase):
    ...
    def test_float_y(self):
        with self.assertRaisesRegex(TypeError, "y must be a integer"):
            Rectangle(1, 2, 3, 5.5)
...
class TestRectangle_stdout(unittest.TestCase):
    ...
    def capture_stdout(rect, method):
        """Captures then returns text printed to stdout
